...
public class ItemController {
    ...
    @GetMapping("/{id}")
    public ItemDto findItemById(@PathVariable(name = "id") Long itemId) {
    ...
    @GetMapping
    public List<ItemDto> getItems(@RequestHeader(OWNER_ID) Long ownerId) {
        log.info("Пришел GET-запрос /users with ownerId={}", ownerId);
        List<ItemDto> itemDtos = itemService.findItemsByOwnerId(ownerId);
